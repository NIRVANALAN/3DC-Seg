...
_C.MODEL.BACKBONE.UP_CONV1_INPLANES = [384, 768, 1280, 1280, 1024]
_C.MODEL.BACKBONE.UP_CONV1_OUTPLANES = [64, 256, 512, 512, 512]
_C.MODEL.BACKBONE.INPUT_C = 3
_C.MODEL.BACKBONE.OUTPUT_C = 3
_C.MODEL.BACKBONE.DEEPBLENDER = False
